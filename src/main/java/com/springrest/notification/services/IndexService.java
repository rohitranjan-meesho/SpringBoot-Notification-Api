...
import com.springrest.notification.helper.IndexUtil;
...
public class IndexService {
    ...
    private static final List<String> INDICES = Arrays.asList(Indices.SMS_INDEX);
    ...
    public void recreateIndices(final boolean deleteExisting) {
        final String settings = IndexUtil.loadAsString("static/es-settings.json");
    ...
    private String loadMappings(String indexName) {
        final String mappings = IndexUtil.loadAsString("static/mappings/" + indexName + ".json");
        if (mappings == null) {
